...
<html class="no-js" lang="zxx">
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?= base_url() ?>assets/artikel/img/favicon.ico">
    ...
    <!-- CSS here -->
            ...
            <link rel="stylesheet" href="<?= base_url() ?>assets/artikel/css/style.css">
   </head>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="<?= base_url() ?>assets/artikel/img/logo/logo.png" alt="">
                </div>
            </div>
        </div>
    </div> -->
                       ...
                       <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left">
                                    <ul>
                                        <li><img src="<?= base_url() ?>assets/artikel/img/icon/header_icon1.png" alt="">34ºc, Sunny </li>
                                        <li><img src="<?= base_url() ?>assets/artikel/img/icon/header_icon1.png" alt="">Tuesday, 18th June, 2019</li>
                                    </ul>
                                </div>
                   ...
                   <div class="container">
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3">
                                <div class="logo">
                                    <a href="index.html"><img src="<?= base_url() ?>assets/artikel/img/logo/logo.png" alt=""></a>
                                </div>
                            </div>
                            <div class="col-xl-9 col-lg-9 col-md-9">
                                <div class="header-banner f-right ">
                                    <img src="<?= base_url() ?>assets/artikel/img/hero/header_card.jpg" alt="">
                                </div>
                            </div>
                        </div>
                   </div>
                        ...
                        <div class="weekly-news-active dot-style d-flex dot-style">
                            <div class="weekly-single">
                                <div class="weekly-img">
                                    <img src="<?= base_url() ?>assets/artikel/img/news/weeklyNews2.jpg" alt="">
                                </div>
                            ...
                            <div class="weekly-single active">
                                <div class="weekly-img">
                                        <img src="<?= base_url() ?>assets/artikel/img/news/weeklyNews1.jpg" alt="">
                                </div>
                                <div class="weekly-caption">
                                    <span class="color1">Strike</span>
                                    <h4><a href="#">Welcome To The Best Model  Winner Contest</a></h4>
                            ...
                            <div class="weekly-single">
                                <div class="weekly-img">
                                        <img src="<?= base_url() ?>assets/artikel/img/news/weeklyNews3.jpg" alt="">
                                </div>
                                <div class="weekly-caption">
                                    <span class="color1">Strike</span>
                                    <h4><a href="#">Welcome To The Best Model  Winner Contest</a></h4>
                    ...
                    <div class="col-12">
                        <div class="recent-active dot-style d-flex dot-style">
                            <div class="single-recent mb-100">
                                <div class="what-img">
                                    <img src="<?= base_url() ?>assets/artikel/img/news/recent1.jpg" alt="">
                                </div>
                                <div class="what-cap">
                                    <span class="color1">Night party</span>
                                    <h4><a href="#">Welcome To The Best Model  Winner Contest</a></h4>
                            ...
                            <div class="single-recent mb-100">
                                <div class="what-img">
                                    <img src="<?= base_url() ?>assets/artikel/img/news/recent2.jpg" alt="">
                                </div>
                                <div class="what-cap">
                                    <span class="color1">Night party</span>
                                    <h4><a href="#">Welcome To The Best Model  Winner Contest</a></h4>
                            ...
                            <div class="single-recent mb-100">
                                <div class="what-img">
                                    <img src="<?= base_url() ?>assets/artikel/img/news/recent3.jpg" alt="">
                                </div>
                                <div class="what-cap">
                                    <span class="color1">Night party</span>
                                    <h4><a href="#">Welcome To The Best Model  Winner Contest</a></h4>
                        ...
                        <div class="single-footer-caption">
                            <div class="single-footer-caption">
                                ...
                                <div class="footer-logo">
                                    <a href="index.html"><img src="<?= base_url() ?>assets/artikel/img/logo/logo2_footer.png" alt=""></a>
                                </div>
                                ...
                                <div class="footer-form" >
                                    <div id="mc_embed_signup">
                                        ...
                                        method="get" class="subscribe_form relative mail_part">
                                            ...
                                            class="email_icon newsletter-submit button-contactForm"><img src="<?= base_url() ?>assets/artikel/img/logo/form-iocn.png" alt=""></button>
                                            </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-6">
                        <div class="single-footer-caption mb-50 mt-60">
                            ...
                            <div class="instagram-gellay">
                                <ul class="insta-feed">
                                    <li><a href="#"><img src="<?= base_url() ?>assets/artikel/img/post/instra1.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="<?= base_url() ?>assets/artikel/img/post/instra2.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="<?= base_url() ?>assets/artikel/img/post/instra3.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="<?= base_url() ?>assets/artikel/img/post/instra4.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="<?= base_url() ?>assets/artikel/img/post/instra5.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="<?= base_url() ?>assets/artikel/img/post/instra6.jpg" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
