...
<head>
  ...
  <title>Aku Sehat - Website Kesehatan</title>
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      <!-- logo brand -->
      <a href="<?php base_url('homepage') ?>" class="logo me-auto"><img src="<?php echo base_url() ?>assets/img/logo.png" alt="+Aku Sehat" class="img-fluid"></a>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="<?php echo base_url('user/obat') ?>">Obat & Vitamin</a></li>
          <li><a class="nav-link scrollto" href="#doctors">Artikel</a></li>
          <li class="dropdown"><a href="#"><span>Tentang Kami</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a class="nav-link scrollto" href="#">Team</a></li>
              <li><a class="nav-link scrollto" href="#contact">Site Map</a></li>
...
== next cek bagian mulai dari sini -->
      <a href="<?php echo base_url('user/login') ?>" class="appointment-btn scrollto"><span class="d-none d-md-inline"></span>Login</a>
            ...
            <div class="icon-boxes d-flex flex-column justify-content-center">
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="pic">
                    <img src="<?php echo base_url() ?>assets/img/content1.png" alt="Konsultasi" class="img-fluid">
                  </div>
                ...
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="pic">
                    <img src="<?php echo base_url() ?>assets/img/content2.png" alt="Obat" class="img-fluid">
                  </div>
                  <!-- <div class="icon-box mt-4 mt-xl-0">
                ...
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="pic">
                    <img src="<?php echo base_url() ?>assets/img/content3.png" alt="Artikel" class="img-fluid">
                  </div>
                  <!-- <div class="icon-box mt-4 mt-xl-0">
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 footer-contact">
            <h3>Aku Sehat</h3>
            <p>
              Jl. RS. Fatmawati Raya No.24,
              RT.7/RW.1, <br>
              Pd. Labu, Kec. Cilandak, <br>
              Kota Jakarta Selatan,<br>
              DKI Jakarta 12450 <br><br>
              <strong>Phone:</strong> +62 812 3456 789<br>
              <strong>Email:</strong> cs.akusehat@gmail.com<br>
            </p>
          </div>
          ...
          <div class="col-lg-6 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a class="nav-link scrollto" href="#services">Konsultasi</a></li>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>Aku Sehat</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          Made with ❤️
        </div>
